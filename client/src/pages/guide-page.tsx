...
export default function GuidePage() {
  ...
  const forestCityLocations = [
    ...
    {
      id: "fc-4",
      position: [1.4255, 103.624] as [number, number],
      name: "Malaysian CIQ",
    },
  ];
  return (
      ...
      <main className="container mx-auto py-6 px-4 pt-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-2">
            Singapore-Forest City Travel Guide
          </h1>
          <p className="text-muted-foreground mb-6">
            Essential information for traveling between Singapore and Forest
            City
          </p>
        </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Alert className="bg-amber-50 border-amber-200">
              ...
              <AlertDescription className="text-amber-700">
                Ensure your passport has at least 6 months validity. Many
                travelers forget their passports - double-check before leaving!
              </AlertDescription>
            </Alert>
            ...
            <Alert className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription className="text-blue-700">
                Allow 45-60 minutes for immigration during peak hours. Weekday
                mornings (Singapore entry) and evenings (Malaysia entry) are
                busiest.
              </AlertDescription>
            </Alert>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-2">
                      <li>
                        <strong>Journey:</strong> Jurong Town Hall Bus
                        Interchange → CIQ 2nd Link → Forest City
                      </li>
                      <li>
                        <strong>Buses:</strong> Take CW3/CW4/CW4S/CW6/CW7, then
                        FC1 after immigration
                      </li>
                      <li>
                        <strong>Total fare:</strong> S$5 (through-ticketing
                        available)
                      </li>
                      <li>
                        <strong>Payment:</strong> Cash or ManjaLink card
                      </li>
                      <li>
                        <strong>Travel time:</strong> ~1.5-2 hours including
                        immigration
                      </li>
                    </ul>
                  </div>
                  ...
                  <Alert className="bg-amber-50 border-amber-200 mt-4">
                    ...
                    <AlertDescription className="text-amber-700">
                      Buses from CIQ 2nd Link depart{" "}
                      <strong>only once per hour</strong>. Missing your bus
                      could mean a long wait!
                    </AlertDescription>
                  </Alert>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-slate-50 p-3 rounded-md">
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li>
                      <strong>Cryptocurrency:</strong> USDC on BASE or SOL, for
                      peer-to-peer payments
                    </li>
                    <li>
                      <strong>Cash:</strong> Pay in SGD or RM depending on
                      driver preference
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-slate-50 p-3 rounded-md">
                  <ul className="space-y-2 text-sm">
                    <li>
                      <strong>ManjaLink Card:</strong> Cashless payment option
                      for regular commuters
                    </li>
                    <li>
                      <strong>Contactless Bank Card:</strong> Visa, Apple Pay
                    </li>
                    <li>
                      <strong>Cash: </strong>Not tested.
                    </li>
                  </ul>
                </div>
